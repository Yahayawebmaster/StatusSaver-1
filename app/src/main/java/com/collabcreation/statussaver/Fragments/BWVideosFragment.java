...
public class BWVideosFragment extends Fragment {

    ArrayList<Status> videoStatusList;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new VideoAdapter(videoStatusList, getActivity(), "BW");
    ...
    public void getStatus() {
        if (Common.getBWhatsappDirectory().exists()) {
            process.setVisibility(View.VISIBLE);
            dialog.setMessage("Loading...");
            dialog.setCancelable(false);
            dialog.show();
            File[] statusFiles = Common.getBWhatsappDirectory().listFiles();
