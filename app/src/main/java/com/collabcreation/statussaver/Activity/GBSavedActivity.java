...
public class GBSavedActivity extends AppCompatActivity implements SavedStatusListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gbsaved);
    ...
    private void getStatus() {
        if (Common.getGBOurDirectory().exists()) {
            process.setVisibility(View.VISIBLE);
            File[] statusFiles = Common.getGBOurDirectory().listFiles();
    ...
    public void onThumnailClick(int postition, Status status) {
        View v = LayoutInflater.from(GBSavedActivity.this).inflate(R.layout.dialog, null, false);
        final Dialog dialog = new Dialog(GBSavedActivity.this, android.R.style.Theme_Black_NoTitleBar_Fullscreen);
    ...
    public void onDeleteClick(final int position, final ArrayList<Status> statuses) {
        ...
        if (file.exists()) {
            final AlertDialog.Builder load = new AlertDialog.Builder(GBSavedActivity.this)
                    .setTitle("Delete")
