...
public class SavedActivity extends AppCompatActivity implements SavedStatusListener {
    ...
    private void getStatus() {
        if (Common.getOurDirectory().exists()) {
            process.setVisibility(View.VISIBLE);
            File[] statusFiles = Common.getOurDirectory().listFiles();
    ...
    public void onThumnailClick(int postition, Status status) {
        View v = LayoutInflater.from(SavedActivity.this).inflate(R.layout.dialog, null, false);
        final Dialog dialog = new Dialog(SavedActivity.this, android.R.style.Theme_Black_NoTitleBar_Fullscreen);
    ...
    public void onDeleteClick(final int position, final ArrayList<Status> statuses) {
        ...
        if (file.exists()) {
            final AlertDialog.Builder load = new AlertDialog.Builder(SavedActivity.this)
                    .setTitle("Delete")
